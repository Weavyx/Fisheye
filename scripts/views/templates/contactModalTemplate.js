/**
 * Génère un modèle pour afficher une modale de contact.
 * @param {Object} data - Les données nécessaires pour le modèle.
 * @param {string} data.photographerName - Le nom du photographe à contacter.
 * @returns {Object} Un objet contenant les données et une méthode pour obtenir le DOM de la modale de contact.
 */
export function contactModalTemplate(data) {
  ...
  return { photographerName, getModalDOM };
}
