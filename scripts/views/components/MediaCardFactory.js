export function createMediaCard(data) {
  ...
  cardElement.innerHTML = `
    ...
    <div class="photograph-work__media-info">
      <p class="photograph-work__media-title">${title}</p>
      <span class="photograph-work__likes-container">
        <p class="photograph-work__likes">${likes}</p>
        <svg viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="photograph-work__heart-icon">
